      ...
      <Card className="gap-0 overflow-hidden py-0 shadow-md">
        <CardHeader className="gap-1.5 border-b border-border bg-neutral-100 px-6 pt-8 pb-6 text-center sm:px-8">
          {/*
            ...
            Le filet sépare le titre des champs, comme il sépare déjà le pied
            (« Vous n'avez pas de compte ? ») du formulaire — même langage aux
            deux bords de la carte, et la même bande `neutral-100` : les deux
            extrémités reculent d'un ton, le blanc de la carte ne reste que là
            où l'on saisit. `neutral-100` et non `neutral-50` : ce dernier est
            déjà le fond de page (`CadreAuthDouble`), la bande s'y serait
            fondue au lieu de creuser la carte.
          */}

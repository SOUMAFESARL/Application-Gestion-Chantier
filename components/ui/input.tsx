 ...
 *
 * Deux écarts au fichier généré (mêmes raisons que `button.tsx`) : la
 * hauteur, le rembourrage et le rayon viennent des jetons `--input-*` de la
 * charte plutôt que de l'échelle de shadcn — 48 px est la cible tactile du

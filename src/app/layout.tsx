...
/**
 * Inter est imposée par la charte (§3) et n'est pas personnalisable,
 * même en white-label. next/font l'auto-héberge : pas de requête vers
 * Google, pas de décalage de mise en page au chargement.
 */
const inter = Inter({
  subsets: ["latin"],

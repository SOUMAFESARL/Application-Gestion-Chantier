 ...
 *
 * Trois écarts au fichier généré, tous voulus (plan de refonte, lot 2) :
 *
 * 1. **Les variantes `dark:` sont retirées** — arbitrage A3, il n'y a pas de
 *    mode sombre. Laissées en place, elles ne seraient pas du code mort : la
 *    variante `dark` de Tailwind v4 suit `prefers-color-scheme`, donc elles
 *    s'appliqueraient chez toute personne dont le système est en sombre, sur
 *    une interface qui ne l'est pas.
